...
import com.wiserock.heruri.databinding.FragmentPlanner3Binding
import com.wiserock.heruri.utils.classes.Planner
import com.wiserock.heruri.view.adapter.PlannerAdapter
import kotlinx.android.synthetic.main.fragment_planner3.view.*
import java.util.*
...
class Planner3Fragment : Fragment() {
    override fun onCreateView(
        ...
        val binding: FragmentPlanner3Binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_planner3, container, false)
        val viewModel = ViewModelProvider(this).get(PlannerViewModel::class.java)
        PlannerAdapter.viewModel = viewModel
        val view = binding.root
        val recycler = view.fragment3_planner_recycler
